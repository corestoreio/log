...
// New creates a logger based on the "testing.TB.Log" function and logs
// level independent, for now. Signature of `logger`:
//		type logger interface {
//			Log(args ...interface{})
//		}
func New(l logger, fields ...log.Field) log.Logger {
	return &tLog{
		l:   l,
		ctx: fields,
	}
